    ...
    initialize: function (input, options) {
        ...
        this.panel
            ...
            .on('mouseenter', item_selector, function(e) {
                self._preselect($(this));
            })
            .on('click', item_selector, function(e){
                self._select($(this));
            });

        lang.bind('command', this);
        ...
        switch (e.keyCode) {
            ...
            case 40:
                ...
                if( index > -1 && index < this.items.length ){
                    self._preselect( this.items.eq(index) );
                }

                break; //down

            case 13:
                self._select( this.items.eq(this.selectedIndex) );
                break;
        }
    },
